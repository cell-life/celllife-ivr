...
public class Campaign implements Serializable {
    ...
    public Campaign(Long id, String name, String description, int duration, String callFlowName, String channelName, String scheduleName, Long verboiceProjectId) {
        this.id = id;
        this.name = name;
    ...
    public Campaign(String name, String description, int duration, String callFlowName, String channelName, String scheduleName, Long verboiceProjectId) {
        this.name = name;
        this.description = description;
        this.duration = duration;
        this.callFlowName = callFlowName;
